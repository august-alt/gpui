...
std::unique_ptr<PreferencesModel> NetworkModelBuilder::schemaToModel(std::unique_ptr<NetworkOptions> &network)
{
    ...
    for (const auto &networkoptionsschema : network->VPN())
    {
        ...
        for (const auto &properties : networkoptionsschema.Properties())
        {
            ...
            vpn->setProperty<int>(VpnItem::propertyToString(VpnItem::ACTION), action);
            ...
            vpn->setProperty<std::string>(VpnItem::propertyToString(VpnItem::IP_ADDRESS),
                                          getOptionalPropertyData(properties.ipAddress()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::USE_DNS),
                                   getOptionalPropertyData(properties.useDNS()));
            vpn->setProperty<std::string>(VpnItem::propertyToString(VpnItem::DIAL_FIRST),
                                          getOptionalPropertyData(properties.dialFirst()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::TRAY_ICON),
                                   getOptionalPropertyData(properties.trayIcon()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::SHOW_PROGRESS),
                                   getOptionalPropertyData(properties.showProgress()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::SHOW_PASSWORD),
                                   getOptionalPropertyData(properties.showPassword()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::SHOW_DOMAIN),
                                   getOptionalPropertyData(properties.showDomain()));
            vpn->setProperty<int>(VpnItem::propertyToString(VpnItem::REDIAL_COUNT),
                                  getOptionalPropertyData(properties.redialCount()));
            vpn->setProperty<int>(VpnItem::propertyToString(VpnItem::REDIAL_PAUSE),
                                  std::atoi(getOptionalPropertyData(properties.redialPause()).c_str()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::IDLE_DISCONNECT),
                                   getOptionalPropertyData(properties.idleDisconnect()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::RECONNECT),
                                   getOptionalPropertyData(properties.reconnect()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::CUSTOM_SETTINGS),
                                   getOptionalPropertyData(properties.customSettings()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::SECURE_PASSWORD),
                                   getOptionalPropertyData(properties.securePassword()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::SECURE_DATA),
                                   getOptionalPropertyData(properties.secureData()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::USE_LOGON),
                                   getOptionalPropertyData(properties.useLogon()));
            vpn->setProperty<std::string>(VpnItem::propertyToString(VpnItem::VPN_STRATEGY),
                                          getOptionalPropertyData(properties.vpnStrategy()));
            vpn->setProperty<std::string>(VpnItem::propertyToString(VpnItem::ENCRYPTION_TYPE),
                                          getOptionalPropertyData(properties.encryptionType()));
            ...
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::MS_CHAP),
                                   getOptionalPropertyData(properties.msChap()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::OLD_MS_CHAP),
                                   getOptionalPropertyData(properties.oldMsChap()));
            vpn->setProperty<bool>(VpnItem::propertyToString(VpnItem::MS_CHAP_V2),
                                   getOptionalPropertyData(properties.msChapV2()));
    ...
    for (const auto &networkoptionsschema : network->DUN())
    {
        ...
        for (const auto &properties : networkoptionsschema.Properties())
        {
            ...
            dun->setProperty<int>(DialUpItem::propertyToString(DialUpItem::ACTION), action);
            ...
            dun->setProperty<std::string>(DialUpItem::propertyToString(DialUpItem::PHONE_NUMBER),
    ...
    for (const auto &containerItem : model->topItems())
    {
        ...
        if (auto dunContainer = dynamic_cast<NetworkContainerItem<DialUpItem> *>(containerItem); dunContainer)
        {
            ...
            auto properties = DUNProperties_t(dunModel->property<bool>(DialUpItem::propertyToString(DialUpItem::USER)),
                                              dunModel->property<std::string>(
                                                  DialUpItem::propertyToString(DialUpItem::NAME)),
                                              dunModel->property<std::string>(
                                                  DialUpItem::propertyToString(DialUpItem::PHONE_NUMBER)));
