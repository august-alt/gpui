...
/**
 * @file
 * @brief Generated from devicesschema.xsd.
 */

#ifndef CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_DEVICESSCHEMA_H
#define CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_DEVICESSCHEMA_H
...
class Properties_t: public ::xml_schema::Type
{
   ...
   * @name deviceAction
   *
   * @brief Accessor and modifier functions for the %deviceAction
   * required attribute.
   */
  //@{
   ...
   */
  typedef ::xml_schema::String DeviceActionType;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< DeviceActionType, char > DeviceActionTraits;
   ...
   */
  void
  deviceAction (::std::unique_ptr< DeviceActionType > p);
   ...
   * @name deviceClass
   *
   * @brief Accessor and modifier functions for the %deviceClass
   * optional attribute.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::String DeviceClassType;

  /**
   * @brief Attribute optional container type.
   */
  typedef ::xsd::cxx::tree::optional< DeviceClassType > DeviceClassOptional;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< DeviceClassType, char > DeviceClassTraits;
   ...
   */
  void
  deviceClass (::std::unique_ptr< DeviceClassType > p);
   ...
   * @name deviceType
   *
   * @brief Accessor and modifier functions for the %deviceType
   * optional attribute.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::String DeviceTypeType;

  /**
   * @brief Attribute optional container type.
   */
  typedef ::xsd::cxx::tree::optional< DeviceTypeType > DeviceTypeOptional;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< DeviceTypeType, char > DeviceTypeTraits;
   ...
   */
  void
  deviceType (::std::unique_ptr< DeviceTypeType > p);
   ...
   *
   * @brief Accessor and modifier functions for the %deviceClassGUID
   * required attribute.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::String DeviceClassGUIDType;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< DeviceClassGUIDType, char > DeviceClassGUIDTraits;
   ...
   */
  void
  deviceClassGUID (::std::unique_ptr< DeviceClassGUIDType > p);
   ...
   * @name deviceTypeID
   *
   * @brief Accessor and modifier functions for the %deviceTypeID
   * required attribute.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::String DeviceTypeIDType;
   ...
   */
  void
  deviceTypeID (::std::unique_ptr< DeviceTypeIDType > p);
   ...
   */
  Properties_t (const DeviceActionType&,
                const DeviceClassGUIDType&,
                const DeviceTypeIDType&);
  ...
  protected:
  ::xsd::cxx::tree::one< DeviceActionType > deviceAction_;
  DeviceClassOptional deviceClass_;
  DeviceTypeOptional deviceType_;
  ::xsd::cxx::tree::one< DeviceClassGUIDType > deviceClassGUID_;
 ...
 * @nosubgrouping
 */
class Device_t: public ::xml_schema::Type
{
  public:
  /**
   * @name Properties
   ...
   */
  Device_t (::std::unique_ptr< PropertiesType >,
            const ClsidType&,
            const NameType&,
            const UidType&);
...
/**
 * @brief Class corresponding to the %Devices schema type.
 *
 * @nosubgrouping
 */
class Devices: public ::xml_schema::Type
{
  public:
  /**
   * @name Device
   ...
   */
  void
  Device (::std::unique_ptr< DeviceType > p);
   ...
   * instead of making copies.
   */
  Devices (::std::unique_ptr< DeviceType >,
           const ClsidType&);
...
::std::ostream&
operator<< (::std::ostream&, const Device_t&);

::std::ostream&
operator<< (::std::ostream&, const Devices&);
...
/**
 * @name Parsing functions for the %Devices document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::Devices >
Devices_ (::xercesc::InputSource& is,
          ::xml_schema::Flags f = 0,
          const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::Devices >
Devices_ (const ::xercesc::DOMDocument& d,
          ::xml_schema::Flags f = 0,
          const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
/**
 * @name Serialization functions for the %Devices document root.
 */
//@{
 ...
 */
void
Devices_ (::xercesc::XMLFormatTarget& ft,
          const ::Devices& x, 
          const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
          const ::std::string& e = "UTF-8",
          ::xml_schema::Flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const Devices&);
...
#endif // CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_DEVICESSCHEMA_H
