...
/**
 * @file
 * @brief Generated from filesschema.xsd.
 */

#ifndef CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_FILESSCHEMA_H
#define CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_FILESSCHEMA_H
...
/**
 * @brief Class corresponding to the %FileProperties_t schema type.
 *
 * @nosubgrouping
 */
class FileProperties_t: public ::xml_schema::Type
{
  public:
  /**
   * @name action
   ...
   * @name fromPath
   *
   * @brief Accessor and modifier functions for the %fromPath
   * optional attribute.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::String FromPathType;

  /**
   * @brief Attribute optional container type.
   */
  typedef ::xsd::cxx::tree::optional< FromPathType > FromPathOptional;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< FromPathType, char > FromPathTraits;
   ...
   */
  void
  fromPath (::std::unique_ptr< FromPathType > p);
   ...
   * @brief Attribute optional container type.
   */
  typedef ::xsd::cxx::tree::optional< ReadOnlyType > ReadOnlyOptional;
   ...
   * @brief Attribute optional container type.
   */
  typedef ::xsd::cxx::tree::optional< ArchiveType > ArchiveOptional;
   ...
   * @name suppress
   *
   * @brief Accessor and modifier functions for the %suppress
   * optional attribute.
   */
  //@{
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::Boolean SuppressType;

  /**
   * @brief Attribute optional container type.
   */
  typedef ::xsd::cxx::tree::optional< SuppressType > SuppressOptional;

  /**
   * @brief Attribute traits type.
   */
  typedef ::xsd::cxx::tree::traits< SuppressType, char > SuppressTraits;
   ...
   */
  FileProperties_t (const TargetPathType&);
  ...
  FromPathOptional fromPath_;
  ::xsd::cxx::tree::one< TargetPathType > targetPath_;
  ReadOnlyOptional readOnly_;
  ArchiveOptional archive_;
  HiddenOptional hidden_;
  SuppressOptional suppress_;
...
class File_t: public ::xml_schema::Type
{
   ...
   * @brief Element type.
   */
  typedef ::FileProperties_t PropertiesType;
...
/**
 * @brief Class corresponding to the %Files schema type.
 *
 * @nosubgrouping
 */
...
::std::ostream&
operator<< (::std::ostream&, const FileProperties_t&);

::std::ostream&
operator<< (::std::ostream&, const File_t&);
...
/**
 * @name Parsing functions for the %Files document root.
 */
//@{
 ...
 */
::std::unique_ptr< ::Files >
Files_ (const ::xercesc::DOMDocument& d,
        ::xml_schema::Flags f = 0,
        const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
void
operator<< (::xercesc::DOMElement&, const FileProperties_t&);

void
operator<< (::xercesc::DOMElement&, const File_t&);

/**
 * @name Serialization functions for the %Files document root.
 */
//@{
 ...
 */
void
Files_ (::xercesc::XMLFormatTarget& ft,
        const ::Files& x, 
        const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
        const ::std::string& e = "UTF-8",
        ::xml_schema::Flags f = 0);
...
#endif // CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_FILESSCHEMA_H
