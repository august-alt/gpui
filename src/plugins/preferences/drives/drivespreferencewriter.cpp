...
{
DrivesPreferenceWriter::DrivesPreferenceWriter()
    : BasePreferenceWriter("DrivesContainerItem")
{}

bool DrivesPreferenceWriter::writeModel(std::ostream &output, const std::unique_ptr<PreferencesModel> &model)
{
