...
/**
 * @file
 * @brief Generated from variablesschema.xsd.
 */

#ifndef CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_VARIABLESSCHEMA_H
#define CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_VARIABLESSCHEMA_H
...
//
class EnvironmentVariableProperties_t;
...
/**
 * @brief Class corresponding to the %EnvironmentVariableProperties_t schema type.
 *
 * @nosubgrouping
 */
class EnvironmentVariableProperties_t: public ::xml_schema::Type
{
  public:
  /**
   * @name action
   ...
   */
  EnvironmentVariableProperties_t (const NameType&,
                                   const ValueType&);
   ...
   */
  virtual EnvironmentVariableProperties_t*
...
class EnvironmentVariable_t: public ::xml_schema::Type
{
   ...
   * @brief Element type.
   */
  typedef ::EnvironmentVariableProperties_t PropertiesType;
...
::std::ostream&
operator<< (::std::ostream&, const EnvironmentVariableProperties_t&);
...
/**
 * @name Parsing functions for the %EnvironmentVariables document root.
 */
//@{
...
EnvironmentVariables_ (const ::std::string& uri,
                       ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::EnvironmentVariables >
EnvironmentVariables_ (::xercesc::InputSource& is,
                       ::xml_schema::Flags f = 0,
                       const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::EnvironmentVariables >
EnvironmentVariables_ (const ::xercesc::DOMDocument& d,
                       ::xml_schema::Flags f = 0,
                       const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
void
operator<< (::xercesc::DOMElement&, const EnvironmentVariableProperties_t&);

void
operator<< (::xercesc::DOMElement&, const EnvironmentVariable_t&);

/**
 * @name Serialization functions for the %EnvironmentVariables document root.
 */
//@{
 ...
 */
void
EnvironmentVariables_ (::std::ostream& os,
                       const ::EnvironmentVariables& x, 
 ...
 */
void
EnvironmentVariables_ (::xercesc::XMLFormatTarget& ft,
                       const ::EnvironmentVariables& x, 
                       const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                       const ::std::string& e = "UTF-8",
                       ::xml_schema::Flags f = 0);
...
EnvironmentVariables_ (const ::EnvironmentVariables& x, 
                       const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                       ::xml_schema::Flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const EnvironmentVariables&);
...
#endif // CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_VARIABLESSCHEMA_H
