...
namespace io {
    ...
    public:
        ...
        void addPolicyComments(std::shared_ptr<comments::PolicyComments> policyComments);

        void removePolicyComments(std::shared_ptr<comments::PolicyComments> policyComments);
