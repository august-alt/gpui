...
#ifndef GPUI_IMMEDIATETASKS_WIDGET_H
#define GPUI_IMMEDIATETASKS_WIDGET_H
...
class ImmediateTasksWidget : public BasePreferenceWidget
{
public:
    Q_OBJECT
...
#endif//GPUI_IMMEDIATETASKS_WIDGET_H
