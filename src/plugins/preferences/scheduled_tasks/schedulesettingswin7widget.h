...
#ifndef GPUI_SCHEDULESETTINGSWIN7_WIDGET_H
#define GPUI_SCHEDULESETTINGSWIN7_WIDGET_H
...
class ScheduleSettingsWin7Widget : public BasePreferenceWidget
{
public:
    Q_OBJECT
...
#endif//GPUI_SCHEDULESETTINGSWIN7_WIDGET_H
