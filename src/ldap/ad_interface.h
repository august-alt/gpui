...
public:
    ...
    AdCookie(const AdCookie&) = delete; //copy ctor
    AdCookie(AdCookie&&) = delete; //move ctor
    AdCookie operator=(const AdCookie&) = delete; //copy assignment
    AdCookie operator=(AdCookie&&) = delete; //move assignment
...
public:
    ...
    AdInterface(const AdInterface&) = delete; //copy ctor
    AdInterface(AdInterface&&) = delete; //move ctor
    AdInterface& operator=(const AdInterface&) = delete; //copy assignment
    AdInterface& operator=(AdInterface&&) = delete; //move assignment
