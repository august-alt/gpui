...
/**
 * @file
 * @brief Generated from drivesschema.xsd.
 */

#ifndef CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_DRIVESSCHEMA_H
#define CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_DRIVESSCHEMA_H
...
/**
 * @brief Class corresponding to the %DriveProperties_t schema type.
 *
 * @nosubgrouping
 */
class DriveProperties_t: public ::xml_schema::Type
{
  public:
  /**
   * @name action
   ...
   */
  DriveProperties_t (const PathType&,
                     const PersistentType&,
                     const UseLetterType&,
                     const LetterType&);
...
class Drive_t: public ::xml_schema::Type
{
   ...
   * @brief Element type.
   */
  typedef ::DriveProperties_t PropertiesType;
...
::std::ostream&
operator<< (::std::ostream&, const DriveProperties_t&);
...
void
operator<< (::xercesc::DOMElement&, const DriveProperties_t&);

void
operator<< (::xercesc::DOMElement&, const Drive_t&);

/**
 * @name Serialization functions for the %Drives document root.
 */
//@{
 ...
 */
void
Drives_ (::xercesc::XMLFormatTarget& ft,
         const ::Drives& x, 
         const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
         const ::std::string& e = "UTF-8",
         ::xml_schema::Flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const Drives&);
...
#endif // CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_DRIVESSCHEMA_H
