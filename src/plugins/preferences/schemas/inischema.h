...
/**
 * @file
 * @brief Generated from inischema.xsd.
 */

#ifndef CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_INISCHEMA_H
#define CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_INISCHEMA_H
...
/**
 * @brief Class corresponding to the %IniProperties_t schema type.
 *
 * @nosubgrouping
 */
class IniProperties_t: public ::xml_schema::Type
{
  public:
  /**
   * @name path
   ...
   */
  IniProperties_t (const PathType&);
...
class Ini_t: public ::xml_schema::Type
{
   ...
   * @brief Element type.
   */
  typedef ::IniProperties_t PropertiesType;
...
::std::ostream&
operator<< (::std::ostream&, const IniProperties_t&);
...
/**
 * @name Parsing functions for the %IniFiles document root.
 */
//@{
...
IniFiles_ (const ::std::string& uri,
           ::xml_schema::Flags f = 0,
 ...
 */
::std::unique_ptr< ::IniFiles >
IniFiles_ (::xercesc::InputSource& is,
           ::xml_schema::Flags f = 0,
           const ::xml_schema::Properties& p = ::xml_schema::Properties ());
 ...
 */
::std::unique_ptr< ::IniFiles >
IniFiles_ (const ::xercesc::DOMDocument& d,
           ::xml_schema::Flags f = 0,
           const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
void
operator<< (::xercesc::DOMElement&, const IniProperties_t&);

void
operator<< (::xercesc::DOMElement&, const Ini_t&);

/**
 * @name Serialization functions for the %IniFiles document root.
 */
//@{
 ...
 */
void
IniFiles_ (::xercesc::XMLFormatTarget& ft,
           const ::IniFiles& x, 
           const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
           const ::std::string& e = "UTF-8",
           ::xml_schema::Flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const IniFiles&);
...
#endif // CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_INISCHEMA_H
