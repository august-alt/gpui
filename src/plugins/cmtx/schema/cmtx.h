...
/**
 * @file
 * @brief Generated from cmtx.xsd.
 */

#ifndef CXX_HOME_AUGUST_DEVELOP_GPUI_SRC_PLUGINS_CMTX_SCHEMA_CMTX_H
#define CXX_HOME_AUGUST_DEVELOP_GPUI_SRC_PLUGINS_CMTX_SCHEMA_CMTX_H
...
namespace GroupPolicy
{
  ...
  {
    /**
     * @brief Class corresponding to the %policyComments schema type.
     *
     * @nosubgrouping
     */
    class PolicyComments: public ::xml_schema::Type
    {
      public:
      /**
       ...
       * @brief Element type.
       */
      typedef ::GroupPolicy::CommentDefinitions::PolicyNamespaces PolicyNamespacesType;
       ...
       * @brief Element type.
       */
      typedef ::GroupPolicy::CommentDefinitions::Comments CommentsType;
       ...
       */
      PolicyComments (const PolicyNamespacesType&,
                      const CommentsType&,
                      const ResourcesType&,
                      const RevisionType&,
                      const SchemaVersionType&);
       ...
       */
      PolicyComments (::std::unique_ptr< PolicyNamespacesType >,
                      ::std::unique_ptr< CommentsType >,
    ...
    class PolicyNamespaces: public ::xml_schema::Type
    {
       ...
       * @brief Element type.
       */
      typedef ::GroupPolicy::CommentDefinitions::Using UsingType;
       ...
       */
      void
      using_ (::std::unique_ptr< UsingType > p);
       ...
       * initializers for required elements and attributes.
       */
      PolicyNamespaces (const UsingType&);
       ...
       * instead of making copies.
       */
      PolicyNamespaces (::std::unique_ptr< UsingType >);
      ...
      protected:
      ::xsd::cxx::tree::one< UsingType > using__;

      //@endcond
    };

    /**
     * @brief Class corresponding to the %comments schema type.
     *
     * @nosubgrouping
     */
    class Comments: public ::xml_schema::Type
    {
      public:
      /**
       * @name admTemplate
       *
       * @brief Accessor and modifier functions for the %admTemplate
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::GroupPolicy::CommentDefinitions::AdmTemplate AdmTemplateType;

      /**
       * @brief Element traits type.
       */
      typedef ::xsd::cxx::tree::traits< AdmTemplateType, char > AdmTemplateTraits;
       ...
       */
      void
      admTemplate (::std::unique_ptr< AdmTemplateType > p);
       ...
       * initializers for required elements and attributes.
       */
      Comments (const AdmTemplateType&);
       ...
       * instead of making copies.
       */
      Comments (::std::unique_ptr< AdmTemplateType >);
      ...
      protected:
      ::xsd::cxx::tree::one< AdmTemplateType > admTemplate_;
    ...
    /**
     * @brief Class corresponding to the %using schema type.
     *
     * @nosubgrouping
     */
    class Using: public ::xml_schema::Type
    {
      public:
      /**
       * @name prefix
       ...
       * @brief Attribute type.
       */
      typedef ::xml_schema::String PrefixType;
    ...
    /**
     * @brief Class corresponding to the %admTemplate schema type.
     *
     * @nosubgrouping
     */
    class AdmTemplate: public ::xml_schema::Type
    {
      public:
      /**
       * @name comment
       ...
       * @brief Element type.
       */
      typedef ::GroupPolicy::CommentDefinitions::Comment CommentType;

      /**
       * @brief Element sequence container type.
       */
      typedef ::xsd::cxx::tree::sequence< CommentType > CommentSequence;

      /**
       * @brief Element iterator type.
       */
      typedef CommentSequence::iterator CommentIterator;

      /**
       * @brief Element constant iterator type.
       */
      typedef CommentSequence::const_iterator CommentConstIterator;
    ...
    class String: public ::xml_schema::String
    {
       ...
       * @brief Attribute type.
       */
      typedef ::xml_schema::Decimal MinRequiredRevisionType;

      /**
       * @brief Attribute traits type.
       */
      typedef ::xsd::cxx::tree::traits< MinRequiredRevisionType, char, ::xsd::cxx::tree::schema_type::decimal > MinRequiredRevisionTraits;
       ...
       */
      String (const MinRequiredRevisionType&);
    ...
    class StringTable: public ::xml_schema::Type
    {
       ...
       * @brief Element type.
       */
      typedef ::GroupPolicy::CommentDefinitions::String1 StringType;
    ...
    /**
     * @brief Class corresponding to the %comment schema type.
     *
     * @nosubgrouping
     */
    class Comment: public ::xml_schema::Type
    {
       ...
       * @name policyRef
       *
       * @brief Accessor and modifier functions for the %policyRef
       * required attribute.
       */
      //@{
       ...
       * @brief Attribute type.
       */
      typedef ::xml_schema::String PolicyRefType;

      /**
       * @brief Attribute traits type.
       */
      typedef ::xsd::cxx::tree::traits< PolicyRefType, char > PolicyRefTraits;
       ...
       */
      void
      policyRef (::std::unique_ptr< PolicyRefType > p);
       ...
       * @name commentText
       *
       * @brief Accessor and modifier functions for the %commentText
       * required attribute.
       */
      //@{
       ...
       * @brief Attribute type.
       */
      typedef ::xml_schema::String CommentTextType;

      /**
       * @brief Attribute traits type.
       */
      typedef ::xsd::cxx::tree::traits< CommentTextType, char > CommentTextTraits;
       ...
       */
      void
      commentText (::std::unique_ptr< CommentTextType > p);
      ...
      protected:
      ::xsd::cxx::tree::one< PolicyRefType > policyRef_;
      ::xsd::cxx::tree::one< CommentTextType > commentText_;

      //@endcond
    };

    /**
     * @brief Class corresponding to the %string1 schema type.
     *
     * @nosubgrouping
     */
...
namespace GroupPolicy
{
  ...
  {
    ::std::ostream&
    operator<< (::std::ostream&, const PolicyComments&);

    ::std::ostream&
    operator<< (::std::ostream&, const PolicyNamespaces&);

    ::std::ostream&
    operator<< (::std::ostream&, const Comments&);

    ::std::ostream&
    operator<< (::std::ostream&, const Resources&);

    ::std::ostream&
    operator<< (::std::ostream&, const Using&);

    ::std::ostream&
    operator<< (::std::ostream&, const AdmTemplate&);
    ...
    ::std::ostream&
    operator<< (::std::ostream&, const Comment&);

    ::std::ostream&
    operator<< (::std::ostream&, const String1&);
  }
}
...
namespace GroupPolicy
{
  ...
  {
    /**
     * @name Parsing functions for the %policyComments document root.
     */
    //@{
    ...
    policyComments (const ::std::string& uri,
                    ::xml_schema::Flags f = 0,
     ...
     */
    ::std::unique_ptr< ::GroupPolicy::CommentDefinitions::PolicyComments >
    policyComments (::xercesc::InputSource& is,
                    ::xml_schema::Flags f = 0,
                    const ::xml_schema::Properties& p = ::xml_schema::Properties ());
     ...
     */
    ::std::unique_ptr< ::GroupPolicy::CommentDefinitions::PolicyComments >
    policyComments (const ::xercesc::DOMDocument& d,
                    ::xml_schema::Flags f = 0,
                    const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
namespace GroupPolicy
{
  ...
  {
    /**
     * @name Serialization functions for the %policyComments document root.
     */
    //@{
     ...
     */
    void
    policyComments (::std::ostream& os,
                    const ::GroupPolicy::CommentDefinitions::PolicyComments& x, 
     ...
     */
    void
    policyComments (::xercesc::XMLFormatTarget& ft,
                    const ::GroupPolicy::CommentDefinitions::PolicyComments& x, 
                    const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                    const ::std::string& e = "UTF-8",
                    ::xml_schema::Flags f = 0);
    ...
    policyComments (const ::GroupPolicy::CommentDefinitions::PolicyComments& x, 
                    const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                    ::xml_schema::Flags f = 0);
    ...
    void
    operator<< (::xercesc::DOMElement&, const PolicyComments&);

    void
    operator<< (::xercesc::DOMElement&, const PolicyNamespaces&);

    void
    operator<< (::xercesc::DOMElement&, const Comments&);

    void
    operator<< (::xercesc::DOMElement&, const Resources&);

    void
    operator<< (::xercesc::DOMElement&, const Using&);

    void
    operator<< (::xercesc::DOMElement&, const AdmTemplate&);
    ...
    void
    operator<< (::xercesc::DOMElement&, const String1&);
  }
}
...
#endif // CXX_HOME_AUGUST_DEVELOP_GPUI_SRC_PLUGINS_CMTX_SCHEMA_CMTX_H
