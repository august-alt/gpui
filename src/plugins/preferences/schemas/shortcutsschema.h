...
/**
 * @file
 * @brief Generated from shortcutsschema.xsd.
 */

#ifndef CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_SHORTCUTSSCHEMA_H
#define CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_SHORTCUTSSCHEMA_H
...
/**
 * @brief Class corresponding to the %ShortcutsProperties_t schema type.
 *
 * @nosubgrouping
 */
class ShortcutsProperties_t: public ::xml_schema::Type
{
  public:
  /**
   * @name pidl
   ...
   */
  ShortcutsProperties_t (const TargetTypeType&,
                         const TargetPathType&,
                         const ShortcutPathType&);
...
class Shortcut_t: public ::xml_schema::Type
{
   ...
   * @brief Element type.
   */
  typedef ::ShortcutsProperties_t PropertiesType;
...
::std::ostream&
operator<< (::std::ostream&, const ShortcutsProperties_t&);
...
void
operator<< (::xercesc::DOMElement&, const ShortcutsProperties_t&);

void
operator<< (::xercesc::DOMElement&, const Shortcut_t&);

/**
 * @name Serialization functions for the %Shortcuts document root.
 */
//@{
 ...
 */
void
Shortcuts_ (::xercesc::XMLFormatTarget& ft,
            const ::Shortcuts& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
...
void
operator<< (::xercesc::DOMElement&, const Shortcuts&);
...
#endif // CXX_HOME_AUGUST_DEVELOP_POLICY_PREFERENCES_EDITOR_SRC_APPS_GPUI_SCHEMAS_SHORTCUTSSCHEMA_H
