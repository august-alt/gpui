...
#ifndef GPUI_SHARED_PRINTER_WIDGET_H
#define GPUI_SHARED_PRINTER_WIDGET_H
...
class SharedPrinterWidget : public BasePreferenceWidget
{
public:
    Q_OBJECT
...
#endif//GPUI_SHARED_PRINTER_WIDGET_H
